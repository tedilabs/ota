...
**근거 PRD:** `docs/PRD.md` v1.0.0 (2026-04-24, FINAL) + v1.0.1 §11.3.1 (2026-04-25)
...
**END OF TUI_DESIGN v1.2.0**

*v0.1.1 시각/UX 사양 lock-in. 와이어프레임/키맵 핵심은 v1.0~v1.1 그대로, 신규 추가는 §3.5(sort), §3.6/§3.6a(detail + 라우팅), §15.0a(responsive), §15.7 raw tab(domain.User + M! 토글), §16 골든 4종 + raw 변형, §18 테스트 가이드. team-lead 3개 결정(2026-04-24) 반영 완료: ① 사람 표기 vs 실제 룬, ② OpenResourceMsg → App Shell 라우터, ③ Raw 탭은 마지막 + json.MarshalIndent(domain.User) + M! 토글. developer는 §3.5·§3.6·§3.6a·§15.0a·§15.7을, test-engineer는 §16 새 골든 + §18.7~10을, qa는 §15.0a fill 100% + 정렬 인디케이터 + Detail full coverage + 라우팅 회귀(§18.9)를 각각 검수 기준으로 삼는다.*
