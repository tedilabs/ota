...
func (p *principalUsersPort) Suspend(_ context.Context, _ string) error   { return nil }
func (p *principalUsersPort) Unsuspend(_ context.Context, _ string) error { return nil }
